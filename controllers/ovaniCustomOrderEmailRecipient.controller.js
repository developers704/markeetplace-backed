...
} = require('../services/ovaniCustomOrderEmailRecipient.service');
...
const toggleRecipient = async (req, res) => {
  try {
    ...
    const rec = await OvaniCustomOrderEmailRecipient.findById(id);
    if (!rec) {
...
const addRecipients = async (req, res) => {
  try {
    ...
    for (const userId of ids) {
      await OvaniCustomOrderEmailRecipient.findOneAndUpdate(
...
const deleteRecipient = async (req, res) => {
  try {
    ...
    await OvaniCustomOrderEmailRecipient.findByIdAndDelete(id);

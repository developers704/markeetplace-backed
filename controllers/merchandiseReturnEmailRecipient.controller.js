...
} = require('../services/merchandiseReturnEmailRecipient.service');
...
const toggleRecipient = async (req, res) => {
  try {
    ...
    const rec = await MerchandiseReturnEmailRecipient.findById(id);
    if (!rec) {
...
const addRecipients = async (req, res) => {
  try {
    ...
    for (const userId of ids) {
      await MerchandiseReturnEmailRecipient.findOneAndUpdate(
...
const deleteRecipient = async (req, res) => {
  try {
    ...
    await MerchandiseReturnEmailRecipient.findByIdAndDelete(id);

...
const storeToMainTransferRoutes = require('../routes/storeToMainTransfer.route');
const suppliesCommerceRoutes = require('../routes/suppliesCommerce.route');
...
const b2bStoEmailRecipientRoutes = require('../routes/b2bStoreTransferEmailRecipient.route');
const suppliesOrderEmailRecipientRoutes = require('../routes/suppliesOrderEmailRecipient.route');
const merchandiseReturnEmailRecipientRoutes = require('../routes/merchandiseReturnEmailRecipient.route');
const ovaniCustomOrderEmailRecipientRoutes = require('../routes/ovaniCustomOrderEmailRecipient.route');
const rapnetOrderEmailRecipientRoutes = require('../routes/rapnetOrderEmailRecipient.route');
...
const laravoRoutes      = require('../routes/laravo.route');
...
router.use('/v2/store-to-main', storeToMainTransferRoutes);
...
router.use('/b2b-sto-email', b2bStoEmailRecipientRoutes);
router.use('/supplies-order-email', suppliesOrderEmailRecipientRoutes);
router.use('/merchandise-return-email', merchandiseReturnEmailRecipientRoutes);
router.use('/ovani-custom-email', ovaniCustomOrderEmailRecipientRoutes);
router.use('/rapnet-order-email', rapnetOrderEmailRecipientRoutes);
